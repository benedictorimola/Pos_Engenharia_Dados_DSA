...
modelo_bamr = LogisticRegression()
modelo_bamr.fit(X_treino, y_treino)

# Avaliando o modelo
predictions = modelo_bamr.predict(X_teste)
accuracy = accuracy_score(y_teste, predictions)
print(f"Acurácia do Modelo: {accuracy:.2f}")

# Salvando o modelo
joblib.dump(modelo_bamr, 'modelo_bamr_treinado.pkl')
