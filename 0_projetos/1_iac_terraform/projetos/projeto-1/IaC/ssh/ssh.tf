...
# BAMR - Configuração da chave de segurança para acesso via SSH
# VOcê pode buscar a página de documentação de cada recurso criado, através de busca no Google: <nome recurso> terraform documentation
