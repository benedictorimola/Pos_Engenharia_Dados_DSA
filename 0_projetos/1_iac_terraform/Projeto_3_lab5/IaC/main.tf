...
# É necessário criar no IAM a função ecsTaskExecutionRole. Em seguida, recuperar a arn e colocar no script
# Nesse exemplo a configuração do IAM será feita no conseole AWS
resource "aws_ecs_task_definition" "ecs-task" {
    ...
    cpu                      = var.cpu
    memory                   = var.memory
    execution_role_arn       = "arn:aws:iam::767397908248:role/escTaskEcecutionRoleDSALab5"
    task_role_arn            = "arn:aws:iam::767397908248:role/escTaskEcecutionRoleDSALab5"
